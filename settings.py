...
BOSS_ENEMY_GRENADE_COOLDOWN = 120
BOSS_ENEMY_OUT_OF_RANGE_TIMER = 120
BOSS_ENEMY_SHOOT_COOLDOWN = 10
...
#powerup settings
POWERUP_SPAWN = True
POWERUP_IMAGE = r".\Assets\powerup.png"
POWERUP_SIZE = 0.4
POWERUP_TIME = 300
POWERUP_SAFE_DISTANCE = 100